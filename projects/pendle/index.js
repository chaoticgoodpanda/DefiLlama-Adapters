...
async function avaxTvl(timestamp, block, chainBlocks) {
  ...
  balances[transform(avaxTokens.xJOE)] = (
    await sdk.api.abi.call({
      target: masterChefContract,
      abi: abi.userInfo,
...
module.exports = {
  ...
  methodology:
    "Counts the collateral backing the yield tokens and USDC in the pendle markets, plus staked OT liquidity, and SLP/JLP staked in masterchef. Staking TVL is just staked PENDLE on 0x07282F2CEEbD7a65451Fcd268b364300D9e6D7f5. Pool2 refers to the Pe,P pool on mainnet, and Pa,P pool on avax.",
};
// node test.js projects/pendle/-old.js
