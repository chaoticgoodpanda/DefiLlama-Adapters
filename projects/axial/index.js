...
// node test.js projects/axial/-old.js
...
async function getAxialJLPBalance(_timestamp, _ethereumBlock, chainBlocks) {
  ...
  await unwrapUniswapLPs(
    balances,
    [{ token: AXIAL_JLP_TOKEN, balance: axialBalance }],
    block,
    "avax",
    (addr) => `avax:${addr}`
  );
...
module.exports = {
  methodology:
    "Our TVL is the value of the tokens within the Axial pools, and the Axial LP tokens within our rewards pools MasterChef",
  avalanche: {
    tvl,
